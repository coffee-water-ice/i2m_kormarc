...
VARIABLE_KEYS = [
    "KDC_MODEL_DIR", "KDC_MODEL_VERSION", "KDC_INPUT_SCHEMA", "KDC_EDITION", "KDC_MAX_LEN",
    "KDC_TOC_TOKEN_BUDGET", "KDC_DESC_TOKEN_BUDGET", "KDC_KEYWORD_TOKEN_BUDGET",
    "KDC_SUBTITLE_TOKEN_BUDGET", "KDC_PUBLISHER_TOKEN_BUDGET", "KDC_ADDCODE_TOKEN_BUDGET",
    "KDC_KPIPA_TOC_TOKEN_BUDGET", "KDC_KPIPA_AUTHOR_TOKEN_BUDGET",
    "KPIPA_ENABLE_653",
]
